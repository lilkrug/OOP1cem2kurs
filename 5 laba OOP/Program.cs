...
namespace _5_laba_OOP
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Car car = new Car("МАЗДА", 20, 153, 120000, 3, 200);
            ...
            Car Skoda = new Car("Skoda", 500, 8700, 120000, 7, 150);
            Car Mersedes = new Car("Mersedes", 550, 8800, 200000, 20, 160);
            Car Audi = new Car("Audi", 600, 7700, 180000, 30, 170);
